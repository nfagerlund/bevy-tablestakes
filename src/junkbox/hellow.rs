...
fn greet_peeps(time: Res<Time>, mut timer: ResMut<GreetTimer>, query: Query<&Name, With<Person>>) {
...
fn blunch(timer: Res<GreetTimer>, query: Query<(&Name, &Crumbo), With<Person>>) {

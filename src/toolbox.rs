...
/// Mirror a Rect vertically. Note that mirroring each corner yields valid
/// opposite corners in the new mirrored rectangle, but they're the top left
/// and bottom right, rather than the bottom left (min) and top right (max).
/// (Or, vice-versa if you're using a top-down Y coordinate. you know what I mean.)
